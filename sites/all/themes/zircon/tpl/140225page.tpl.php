      ...
      <div class="grid-inner clearfix">
        <div id="header" class="clearfix"> 
          ...
          <div itemscope itemtype="http://schema.org/ShoppingCenter">
            <a itemprop="url" href="http://www.fiesta4kids.com/" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" id="logo">
              <img itemprop="logo" src="<?php print $logo; ?>" alt="<?php print ('Fiesta Rentals'); ?>" />
            </a>
            </div>
